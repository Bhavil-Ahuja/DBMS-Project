...
router.get("/posts", (req, res) => {
    Post.find({}, function (err, results) {
        res.render("posts", { home: homeStartingContent, posts: results })
    })
})
...
router.get("/notes/1", (req, res) => {
    res.render("year1")
})

router.get("/notes/2", (req, res) => {
    res.render("year2")
})

router.get("/notes/3", (req, res) => {
    res.render("year3")
})

router.get("/notes/4", (req, res) => {
    res.render("year4")
})
